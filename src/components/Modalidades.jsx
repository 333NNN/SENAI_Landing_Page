      ...
      <Row className="justify-content-center">
        ...
        <Col md={6} className="mb-4 d-flex justify-content-center">
          ...
          >
            ...
            <Card.Text>
              Ideais para jovens e adultos a partir de 16 anos que querem
              aprender uma nova profissão de forma rápida ou se certificar na
              área em que já atuam. Com no mínimo 160 horas e certificado
              nacional.
            </Card.Text>
          </Card>
        </Col>
        ...
        <Col md={6} className="mb-4 d-flex justify-content-center">
          ...
          >
            ...
            <Card.Text>
              Ideais para quem está começando no mercado de trabalho. Despertam
              o interesse por atividades específicas e desenvolvem habilidades
